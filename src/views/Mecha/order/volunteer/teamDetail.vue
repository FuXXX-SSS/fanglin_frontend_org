    ...
    <div class="detail" v-if="isShow">
      ...
      <div class="my-block block_bot">
        <el-row type="flex" class="row-bg" justify="center">
          ...
          <el-col :span="3">
            <el-button type="primary" @click="ISdialog" v-if="isRate">确定</el-button>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    async ISdialog() {
      ...
      let res = await walletURL(
        `${this.formData.serviceType}/${this.formData.serviceId}`
      );
      this.walletURL = res.data;
      this.walletURL.amount = this.value;
      this.walletURL.billType = 2;
      this.walletURL.comment = this.formData.comment;
      this.walletURL.score = this.commentScore;
      this.walletURL.id = this.userInfo.id;
