                ...
                <el-col :span="18">
                    ...
                    >
                        ...
                        <el-form-item label="募资目标：">
                            <el-input v-model="formData.targetAmount" style="width: 80%;float: left;" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')"></el-input>
                        ...
                        <el-form-item label="回馈标准：">
                            ...
                            <el-input v-model="formData.refundStd"
                                      style="width: 50%;float: left;margin-left: 10px;margin-right: 10px" onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')"></el-input>
