        ...
        <el-col :span="12">
          ...
          >
            <el-form-item label="机构名称 : ">
              <el-input v-model="formData.name" show-word-limit></el-input>
            </el-form-item>
            ...
            <el-form-item label="机构banner：" style="margin-right: 10px">
              <Banner @load="banner" :isDetail="false" :isUpload="true" />
            </el-form-item>

            <el-form-item label="机构头像：" style="margin-right: 10px" class="avatar">
              <Elupload @load="avatar" :isDetail="true" :isUpload="true" />
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async save() {
      if (this.formData.avatar === "" ||this.formData.banner === "" ) {
